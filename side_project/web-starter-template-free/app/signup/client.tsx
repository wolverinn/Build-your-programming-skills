              ...
              <div className="mx-auto max-w-[500px] rounded-md bg-primary bg-opacity-5 py-10 px-6 dark:bg-dark sm:p-[60px]">
                ...
                <div className="flex flex-row">
                  <div className="mb-8 mr-4">
                    ...
                    />
                    <span className="text-red">{errMsg.vercode}</span>
                  </div>
                  <p className="text-center text-base font-medium text-body-color">
                    <button 
                      className="items-center justify-center rounded-md bg-primary text-base text-white transition duration-300 ease-in-out hover:bg-opacity-80 hover:shadow-signUp"
                    >
                      Send Email Code
                    </button>
                  </p>
